<?php 
session_start();
$connect = mysqli_connect("localhost", "root", "", "decuir");
		...
		<div class="container">
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="cente		<img src="images/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
